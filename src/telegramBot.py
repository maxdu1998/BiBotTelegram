...
class TelegramBot:
            ...
            if messages:
                for message in messages:
                    try:
                        ...
                        answer_bot, figure_boolean = self.create_awnser(
                            message_text)
    ...
    def create_awnser(self, message_text):
        dataframe = transform_data(self.driveBot.get_data())
        if message_text in ["/start", "Oi", "oi", "ola", "Ola", "olá", "Olá"]:
            return "Olá, seja bem vindo ao BIBot, Bot de Análise de dados e Business Intelligence. Selecione o que deseja:" + "\n" + "1 - NPS interno mensal médio por setor" + "\n" + "2 - NPS interno mensal médio por contratação" + "\n" + "3 - Distribuição do NPS interno" + "\n", 0
        elif message_text == '1':
            ...
            return "Não entendi, por favor tente novamente. Selecione o que deseja:" + "\n" + "1 - NPS interno mensal médio por setor" + "\n" + "2 - NPS interno mensal médio por contratação" + "\n" + "3- Distribuição do NPS interno" + "\n", 0
